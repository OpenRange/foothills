...
if ( ! function_exists( 'foothills_entry_footer' ) ) :
/**
 ...
 * @return bool
 */
function foothills_categorized_blog() {
	if ( false === ( $all_the_cool_cats = get_transient( 'foothills_categories' ) ) ) {
		...
		set_transient( 'foothills_categories', $all_the_cool_cats );
	}

	if ( $all_the_cool_cats > 1 ) {
		// This blog has more than 1 category so foothills_categorized_blog should return true.
		return true;
	} else {
		// This blog has only 1 category so foothills_categorized_blog should return false.
		return false;
	}
}
...
add_action( 'edit_category', 'foothills_category_transient_flusher' );
add_action( 'save_post',     'foothills_category_transient_flusher' );
